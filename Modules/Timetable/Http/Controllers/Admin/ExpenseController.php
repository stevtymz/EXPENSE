...
use Modules\Timetable\Expense;
use Modules\Timetable\ExpenseCategory;
use Modules\Timetable\Http\Controllers\Controller;
use Modules\Timetable\Http\Requests\MassDestroyExpenseRequest;
use Modules\Timetable\Http\Requests\StoreExpenseRequest;
use Modules\Timetable\Http\Requests\UpdateExpenseRequest;
use Gate; 
